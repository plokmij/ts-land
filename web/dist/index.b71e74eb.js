...
class User {
    ...
    fetch() {
        (0, _axiosDefault.default).get(`http://localhost:3000/user/${this.get("id")}`).then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"chhsl"}]},["dZ9wo","h7u1C"], "h7u1C", "parcelRequire2d1f")
